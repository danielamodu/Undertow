...
Byte-identical to the file submitted in datahub-project/datahub#18979, except
for the import below: upstream this reads
`from datahub.specific.mlmodel import MLModelPatchBuilder`, which only resolves
once the PR lands. Here it loads the vendored module next to this file.
